...
/// Eye icon — click to reveal a hidden password field.
#[component]
pub fn IEye(#[props(default = "w-4 h-4".to_string())] class: String) -> Element {
    rsx! {
        svg {
            class: "{class}",
            view_box: "0 0 24 24",
...
/// Eye-off icon — click to hide a revealed password field.
#[component]
pub fn IEyeOff(#[props(default = "w-4 h-4".to_string())] class: String) -> Element {
    rsx! {
        svg {
            class: "{class}",
            view_box: "0 0 24 24",
